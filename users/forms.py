...
class UserRegistrationForm(UserCreationForm):
    ...
    # email = forms.CharField(
    #     widget=forms.EmailInput(attrs={"class": "form-control", "placeholder": "Введите вашу эл. почту *youremail@example.com", }))
    # password1 = forms.CharField(
    #     widget=forms.PasswordInput(attrs={"class": "form-control", "placeholder": "Введите ваш пароль", }))
    # password2 = forms.CharField(
    #     widget=forms.PasswordInput(attrs={"class": "form-control", "placeholder": "Поддтвердите ваш пароль", }))
...
class ProfileForm(UserChangeForm):
    ...
    #     attrs={"class": "form-control", "placeholder": "Введите ваш email *youremail@example.com", }))
