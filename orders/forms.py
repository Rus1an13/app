...
class CreateOrderForm(forms.Form):
    ...
    #
    # requires_delivery = forms.CharField(widget=forms.RadioSelect(), choices=[("0", False), ("1", True), ], initial=0, )
    #
    # delivery_address = forms.CharField(widget=forms.Textarea(
    #     attrs={"class": "form-control", "id": "delivery_address", "rows": 2,
    #            "placeholder": "Введите адрес доставки", }), required=False)
    #
    # payment_on_get = forms.ChoiceField(widget=forms.RadioSelect(), choices=[("0", False), ("1", True), ],
    #                                    initial="card", )
